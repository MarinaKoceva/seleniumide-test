...
public void SetUp()
{
    ...
    var driverPath = @"E:\JScript\DEVOPS\08-Exercise-CI-CD-GitHub-Actions-Resources\08-Exercise-CI-CD-GitHub-Actions-Resources\05-SeleniumIDE\2-SeleniumIDE\SeleniumIDE\drivers";


    if (!File.Exists(Path.Combine(driverPath, "chromedriver.exe")))
    {
        Console.WriteLine("❌ chromedriver.exe NOT FOUND in: " + driverPath);
        return;
    }
    ...
    {
        Console.WriteLine("❌ Driver failed to start: " + ex.Message);
        driver = null;
    }
}
